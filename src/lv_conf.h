...
#else       /*LV_MEM_CUSTOM*/
#  define LV_MEM_CUSTOM_INCLUDE <ms_rtos.h>   /*Header for the dynamic memory function*/
#  define LV_MEM_CUSTOM_ALLOC   ms_malloc       /*Wrapper to malloc*/
#  define LV_MEM_CUSTOM_FREE    ms_free         /*Wrapper to free*/
#endif     /*LV_MEM_CUSTOM*/
...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE  <ms_rtos.h>       /*Header for the sys time function*/
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (ms_time_get_ms()) /*Expression evaluating to current systime in ms*/
