...
void setup_scr_home(lv_ui *ui){
	...
	lv_style_set_border_width(&style_home_cont1_main, LV_STATE_DEFAULT, 1);
	...
	lv_style_set_bg_color(&style_home_whitebg_main, LV_STATE_DEFAULT, lv_color_make(0xf6, 0xfa, 0xff));
	...
	lv_style_set_border_width(&style_home_cont2_main, LV_STATE_DEFAULT, 1);
	...
	lv_style_set_text_color(&style_home_imgbtncopy_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	...
	lv_style_set_text_color(&style_home_labelcopy_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_font(&style_home_labelcopy_main, LV_STATE_DEFAULT, &lv_font_simsun_16);
	lv_style_set_text_letter_space(&style_home_labelcopy_main, LV_STATE_DEFAULT, 2);
	...
	lv_style_set_text_color(&style_home_labelscan_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_font(&style_home_labelscan_main, LV_STATE_DEFAULT, &lv_font_simsun_16);
	lv_style_set_text_letter_space(&style_home_labelscan_main, LV_STATE_DEFAULT, 2);
	...
	lv_style_set_text_color(&style_home_labelprt_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_font(&style_home_labelprt_main, LV_STATE_DEFAULT, &lv_font_simsun_16);
	lv_style_set_text_letter_space(&style_home_labelprt_main, LV_STATE_DEFAULT, 2);
	...
	lv_style_set_text_color(&style_home_labelset_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_font(&style_home_labelset_main, LV_STATE_DEFAULT, &lv_font_simsun_16);
	lv_style_set_text_letter_space(&style_home_labelset_main, LV_STATE_DEFAULT, 2);
	...
	lv_style_set_bg_opa(&style_home_labelnote_main, LV_STATE_DEFAULT, 0);
	lv_style_set_text_color(&style_home_labelnote_main, LV_STATE_DEFAULT, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_font(&style_home_labelnote_main, LV_STATE_DEFAULT, &lv_font_simsun_14);
	lv_style_set_text_letter_space(&style_home_labelnote_main, LV_STATE_DEFAULT, 2);
	...
	lv_style_set_border_width(&style_home_contbars_main, LV_STATE_DEFAULT, 1);
